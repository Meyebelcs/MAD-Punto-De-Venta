...
BEGIN
	...
	IF @Accion = 'I'
	BEGIN
		INSERT INTO Empleados(Nombre,APpellidoP,APpellidoM,Telefono,Email,FechaIngreso,CURP,FechaNac,Contraseña,NumNomina)
		VALUES(@Nombre,@APpellidoP,@APpellidoM,@Telefono,@Email,@FechaIngreso,@CURP,@FechaNac,@Contraseña, @NumNomina);
	END;
	...
	BEGIN
		...
		FROM Empleados  
		WHERE IdEmpleados = @IdEmpleados AND Contraseña = @Contraseña;
